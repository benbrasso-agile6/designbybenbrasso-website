      ...
      <main id="main-content" className="min-h-screen bg-white dark:bg-neutral-950">
        <div className="container mx-auto px-4 py-16 sm:py-24">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <Link
              href="/"
              className="text-sky-600 hover:text-sky-700 dark:text-sky-500 dark:hover:text-sky-400 font-medium underline hover:no-underline transition-all duration-200"
            >
              Visit the homepage
            </Link>
