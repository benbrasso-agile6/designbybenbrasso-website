...
export default function HeroSection() {
  return (
    <section className="relative w-full pt-20 md:pt-32 lg:pt-40 pb-10 md:pb-16 lg:pb-20 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-white/85 via-sky-100/60 to-blue-50/50 dark:from-slate-800/60 dark:via-sky-900/40 dark:to-blue-900/35"></div>
      <div className="absolute inset-0 bg-gradient-to-b from-white/75 via-sky-25/30 to-cyan-100/40 dark:from-slate-900/40 dark:via-sky-900/25 dark:to-cyan-900/30"></div>
      ...
      <div className="relative z-10 max-w-[1000px] mx-auto px-8">
        ...
        <div className="flex flex-col-reverse gap-10 lg:grid lg:grid-cols-[1fr_auto] lg:gap-16 items-start">
          ...
          <div className="space-y-6 text-left">
            <div className="bg-white/50 dark:bg-slate-900/50 backdrop-blur-md rounded-2xl p-6 border border-white/30 dark:border-slate-700/40">
