        ...
        <div className="max-w-4xl mx-auto px-6 py-16 space-y-16">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">{caseStudy.timeline}</p>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Tools</h3>
                <p className="text-gray-600 dark:text-gray-400">{caseStudy.tools}</p>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Team</h3>
                <p className="text-gray-600 dark:text-gray-400">{caseStudy.team}</p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">{caseStudy.challenge}</p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">{caseStudy.action}</p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">{caseStudy.keyOutcomes}</p>
            </div>
          </section>

          {/* Project Images */}
          {caseStudy.projectImages && caseStudy.projectImages.length > 0 && (
            <section>
