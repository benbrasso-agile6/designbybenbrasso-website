  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "paragraph",
          text: "Fifteen Veterans—including four who used assistive technology—participated in the remote, moderated concept test and usability resarch study for the community care self-scheduling experience. <strong>Veterans were generally able to complete all tasks and navigate the scheduling process with ease,</strong> though a few friction points emerged. Despite this, many offered unprompted positive feedback about the tool.",
        },
        {
          type: "paragraph",
