...
export const streamliningNofoAuthoringData: CaseStudyData = {
  ...
  projectOverviewBanner: {
    description:
      "The goal of this project was to reduce administrative burden in the creation of Notices of Funding Opportunity (NOFOs) by improving how they are authored, governed, and maintained across HHS. As part of the Simpler NOFO initiative, this work focused on identifying the need for a dedicated authoring and content management tool and validating that need through the NOFO Composer MVP research effort. The result was a working, user-validated MVP that established a research-backed foundation for fast-follow releases, rather than a one-off solution. Insights from the Composer MVP directly inform ongoing improvements to Composer and help guide prioritization within the HHS Office of Grants' broader technology modernization effort, known as Simpler Grants Management.",
    skills:
