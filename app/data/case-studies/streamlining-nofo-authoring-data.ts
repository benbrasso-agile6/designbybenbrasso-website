      ...
      content: [
        {
          ...
          items: [
            ...
            "<strong>Together, these outcomes demonstrated that the Composer MVP was not a one-off prototype, but a research-validated foundation for incremental release and scale.</strong> The work provided clear direction for fast-follow development, including Word export, governance and workflow scaling, and integration with the HHS Office of Grants’ broader Simpler Grants Management modernization effort.",
          ],
        },
      ],
    },
